...
public class MTH {
    ...
    public static double geometricCDF(double successPercent, int lowerBound, int upperBound) {
        ...
        if (successPercent < 0 | successPercent > 1 | lowerBound < 1 | upperBound < 1) {
            return(output);
    ...
    public static double binomialCDF(double successPercent, int trialCount, int lowerBound, int upperBound) {
        ...
        if (successPercent < 0 | successPercent > 1 | lowerBound < 0 | upperBound < 0) {
            return(output);
        } else if (upperBound > trialCount) {
